...
export class CurrencySeed1789901663460 implements MigrationInterface {
  name = 'CurrencySeed1789901663460';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "organization_users" DROP CONSTRAINT "UQ_ef2d3488875cb7728f5375c766e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "organization_invitations" ALTER COLUMN "expires_at" DROP DEFAULT`,
    );
  }
}
